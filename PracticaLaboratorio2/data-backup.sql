...
START TRANSACTION;
USE `AdminViviendas`;
INSERT INTO `AdminViviendas`.`Impuestos` (`idImpuesto`, `fechaInico`, `fechaVencimiento`, `importe`, `fechaActualPago`, `idVivienda`, `dni`) VALUES 
	('YYYY84512', '2018-10-17', '2018-12-26', 300, '2018-11-02', 1, '73793158G'),
	('TYFF47855', '2018-08-11', '2018-11-22', 562.25, '2018-10-15', 2, '73793158G'),
	('YYGR95631', '2018-09-19', '2018-12-25', 956.32, '2018-11-12', 3, '73793158G'),
	('VFRY45223', '2018-08-25', '2018-10-21', 200.65, '2018-09-05', 4, '20039032Y'),
	('XRGZ45123', '2018-11-29', '2019-01-17', 201.90, '2018-12-26', 5, '41679701K'),
	('XTTR12558', '2018-07-02', '2018-09-12', 362.15, '2018-08-29', 6, '71297004V'),
	('XGRG74584', '2018-02-15', '2018-05-13', 253.02, '2018-02-28', 7, '59804933B'),
	('XXWR41054', '2018-04-18', '2018-06-26', 426.332, '2018-05-08', 8, '20039032Y'),
	('HBBE99633', '2018-01-30', '2018-03-11', 481.30, NULL, 9, '23310054Z'),
	('NJMJ51225', '2018-10-22', '2019-02-02', 305.9, '2018-02-01', 10, '73793158G'),
	('KKL575456', '2018-12-15', '2019-03-29', 557.5, NULL, 12, '94328497T');
...
START TRANSACTION;
USE `AdminViviendas`;
INSERT INTO `AdminViviendas`.`Ocupantes` (`dni`, `nombre`, `apellidos`, `fNac`, `idVivienda`) VALUES 
